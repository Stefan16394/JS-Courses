...
const APP_KEY = 'kid_HkdKOQY5M'
const APP_SECRET = '2b3d38b9aaac43d4bfbf3c0627bef017'
...
function loadBookForEdit(book) {
    ...
    $("#formEditBook input[value=Edit").on("click",editBook)
        ...
        onPageClick: function (event, page) {
           ...
           table.find("tr").each((index,el)=>{
            ...
            for (let i = startBook; i < endBook; i++) {
                let newTr=$("<tr>")
                 table.append(newTr.append(`<td>${books[i].title}</td>`)
